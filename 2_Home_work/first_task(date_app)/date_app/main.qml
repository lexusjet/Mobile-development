...
//  Реализуйте форму регистрации для приложения знакомств.
...
//Можете как угодно расширить форму регистрации. В конце формы добавьте кнопку «Регистрация», при нажатии на которую будете писать в консоль отчёт обо всех введённых параметрах.
...
Window {
    ...
    Rectangle{
        ...
        ColumnLayout {
            ...
            anchors.horizontalCenter: main_.horizontalCenter
